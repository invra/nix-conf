    ...
    xdg.configFile = {
      ...
      "mango/config.conf" = mkIf (cfg.settings != { }) {
        text = ''
          ...
          ${(generators.toKeyValue {listsAsDuplicateKeys = true; indent = "";}) (attrsets.zipAttrsWith (_: v: lists.flatten v) [
            cfg.settings (optionalAttrs (!(cfg.autostartSh == null || cfg.autostartSh == "")) {
