...
# layer rule
layerrule=animation_type_open:zoom,layer_name:tofi-drun
layerrule=animation_type_close:zoom,layer_name:tofi-drun

# window rule
windowrule=isfloating:1,height:398,width:700,offsety:99,offsetx:99,isglobal:1,isoverlay:1,title:Picture-in-Picture

monitorrule=eDP-1,0.55,1,tile,0,1,0,0,1920,1080,144
monitorrule=HDMI-A-1,0.55,1,tile,0,1,1925,0,2560,1440,180
